...
class MCMC():
    ...
    def save_plot(self):
        ...
        # slope = np.nansum(m_Behroozi)/np.nansum(m_us_chi)
        slope = 1
        ...
        plt.plot(a_Behroozi, m_Behroozi, "ro", markersize=10 , label="$Behroozi \quad 2013$")
...
pkl_file = open('EMCEE_new_fcon_M12_scipy_4.pkl', 'rb')
...
pkl_file = open('EMCEE_new_fcon_M12_4.pkl', 'rb')
