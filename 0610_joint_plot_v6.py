...
class MCMC():
    ...
    def Plot_M_stellar(self):
        ...
        save_path = plot_path + "Fitting_separately_v6" + str(self.index).replace(".","") + ".png"
    ...
    def Plot_20_Halo_f_con(self):
        ...
        save_path = plot_path + "f_con_Fitting_separately_v6" + str(self.index).replace(".","") + ".png"
        fig.savefig(save_path, dpi=200)
...
class diagnostic():
    ...
    def walker_plot(self):
        ...
        save_path = "/Users/caojunzhi/Downloads/upload_0530_Jeremy/" + "Walker_plot_v6_" + ".png"
        fig.savefig(save_path, dpi=200)
    ...
    def corner_plot(self, fusion):
        ...
        fig.savefig("/Users/caojunzhi/Downloads/upload_0530_Jeremy/" + "triangle_v6.png")
...
save_path = "Separately_best_fit_M11.0_v6.pkl"
...
save_path = "Separately_EMCEEM11.0_v6.pkl".replace("M11.0", str(model.index))
